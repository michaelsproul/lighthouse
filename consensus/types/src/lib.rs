...
pub mod lazy_aggregate_and_proof;
pub mod lazy_attestation;
pub mod lazy_signed_aggregate_and_proof;
...
pub use crate::lazy_aggregate_and_proof::LazyAggregateAndProof;
pub use crate::lazy_attestation::LazyAttestation;
pub use crate::lazy_signed_aggregate_and_proof::LazySignedAggregateAndProof;
